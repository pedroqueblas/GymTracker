...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=1470&auto=format&fit=crop')] bg-cover bg-center">
      ...
      <Card className="w-full max-w-md mx-4 border-none bg-black/40 backdrop-blur-md shadow-2xl text-white">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight text-white">Crie sua conta</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              <Label className="text-gray-200">Escolha seu Avatar</Label>
        ...
        <CardFooter className="flex flex-col space-y-4 text-center">
          ...
          <Link href="/login" className="text-xs text-gray-500 hover:text-gray-300 flex items-center justify-center">
